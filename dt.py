...
BORT_ICO = dict(prfx=IMAGE_DIR+"ico-vh-btn", bort=IMAGE_DIR+"tram-7f.png")
...
#SENSOR_ICO_R0_X0 = 143    # bus
#SENSOR_ICO_R0_Y0 = 54
#SENSOR_ICO_R1_X0 = SENSOR_ICO_R0_X0
#SENSOR_ICO_R1_Y0 = SENSOR_ICO_R0_Y0 + 122
#SENSOR_ICO_R2_X0 = SENSOR_ICO_R1_X0 + 7
#SENSOR_ICO_R2_Y0 = SENSOR_ICO_R1_Y0 + 90
SENSOR_ICO_R0_X0 = 139     # tram
SENSOR_ICO_R0_Y0 = 77
SENSOR_ICO_R1_X0 = SENSOR_ICO_R0_X0 - 4
SENSOR_ICO_R1_Y0 = SENSOR_ICO_R0_Y0 + 122
SENSOR_ICO_R2_X0 = SENSOR_ICO_R1_X0 + 7
SENSOR_ICO_R2_Y0 = SENSOR_ICO_R1_Y0 + 90
SENSOR_ICO = (  # sensor icons
    dict(ico=IMAGE_DIR+'modem.png',           pos=QPoint(SENSOR_ICO_R0_X0 + 467, SENSOR_ICO_R0_Y0 + 16), ds=QPoint(13, 6)),
    dict(ico=IMAGE_DIR+'gps.png',             pos=QPoint(SENSOR_ICO_R0_X0 + 687, SENSOR_ICO_R0_Y0),      ds=QPoint(-3, 23)),
    dict(ico=IMAGE_DIR+'speaker.png',         pos=QPoint(SENSOR_ICO_R1_X0,       SENSOR_ICO_R1_Y0),      ds=QPoint(10, 0)),
    dict(ico=IMAGE_DIR+'info-screen.png',     pos=QPoint(SENSOR_ICO_R1_X0 + 160, SENSOR_ICO_R1_Y0)),
    dict(ico=IMAGE_DIR+'speaker.png',         pos=QPoint(SENSOR_ICO_R1_X0 + 470, SENSOR_ICO_R1_Y0),      ds=QPoint(10, 0)),
    dict(ico=IMAGE_DIR+'ikts.png',            pos=QPoint(SENSOR_ICO_R1_X0 + 670, SENSOR_ICO_R1_Y0),      ds=QPoint(10, 0)),
    dict(ico=IMAGE_DIR+'mobile-terminal.png', pos=QPoint(SENSOR_ICO_R2_X0,       SENSOR_ICO_R2_Y0),      ds=QPoint(5, 0)),
    dict(ico=IMAGE_DIR+'validator-new.png',   pos=QPoint(SENSOR_ICO_R2_X0 + 150, SENSOR_ICO_R2_Y0)),
    dict(ico=IMAGE_DIR+'validator-new.png',   pos=QPoint(SENSOR_ICO_R2_X0 + 300, SENSOR_ICO_R2_Y0)),
    dict(ico=IMAGE_DIR+'validator-new.png',   pos=QPoint(SENSOR_ICO_R2_X0 + 450, SENSOR_ICO_R2_Y0)),
    dict(ico=IMAGE_DIR+'bkts.png',            pos=QPoint(SENSOR_ICO_R2_X0 + 640, SENSOR_ICO_R2_Y0 - 3)),
)
...
<script>
        var stop0 = new google.maps.LatLng(46.433731, 30.697367);
        var center0 = stop0;
        var stops = [[ // forward
{ lat:46.433731, lng:30.697367, title:"вул. Іцкаха Рабіна", delay:"NA"},
{ lat:46.435935, lng:30.699545, title:"вул. Генерала Петрова", delay:"NA"},
{ lat:46.438426, lng:30.701895, title:"вул. Валентини Терешкової", delay:"NA"},
{ lat:46.441191, lng:30.704609, title:"пл. Бориса Дерев'янка", delay:"NA"},
{ lat:46.446403, lng:30.706218, title:"вул. Маршала Малиновського", delay:"NA"},
{ lat:46.451659, lng:30.711122, title:"вул. Івана та Юрія Липи", delay:"NA"},
{ lat:46.451201, lng:30.714115, title:"вул. Єфімова", delay:"NA"},
{ lat:46.450669, lng:30.719275, title:"вул. Скворцова", delay:"NA"},
{ lat:46.453197, lng:30.721411, title:'завод "Краян"', delay:"NA"},
{ lat:46.45418, lng:30.726957, title:"вул. Чернишевського", delay:"NA"},
{ lat:46.460846, lng:30.731206, title:'завод "Стальканат"', delay:"NA"},
{ lat:46.466736, lng:30.738201, title:"Залізничний вокзал", delay:"NA"},
{ lat:46.46797, lng:30.735905, title:'ринок "Привоз"', delay:"NA"},
{ lat:46.470003, lng:30.730669, title:"вул. Пантелеймонівська", delay:"NA"},
{ lat:46.472906, lng:30.731099, title:"вул. Велика Арнаутська", delay:"NA"},
{ lat:46.475995, lng:30.731571, title:"вул. Успенська", delay:"NA"},
{ lat:46.479246, lng:30.731989, title:"пл. Тираспільська", delay:"NA"},
], [    // reverse
{ lat:46.478588, lng:30.731689, title:"пл. Тираспільська", delay:"NA"},
{ lat:46.476409, lng:30.731367, title:"вул. Успенська", delay:"NA"},
{ lat:46.473586, lng:30.730981, title:"вул. Велика Арнаутська", delay:"NA"},
{ lat:46.470468, lng:30.730573, title:"вул. Пантелеймонівська", delay:"NA"},
{ lat:46.467852, lng:30.736195, title:'ринок "Привоз"', delay:"NA"},
{ lat:46.464756, lng:30.734586, title:'КП "ОГЕТ"', delay:"NA"},
{ lat:46.460691, lng:30.730863, title:'завод "Стальканат"', delay:"NA"},
{ lat:46.454231, lng:30.726775, title:"вул. Чернишевського", delay:"NA"},
{ lat:46.453285, lng:30.721239, title:'завод "Краян"', delay:"NA"},
{ lat:46.450861, lng:30.719984, title:"вул. Скворцова", delay:"NA"},
{ lat:46.45129, lng:30.714608, title:"вул. Єфімова", delay:"NA"},
{ lat:46.451068, lng:30.710274, title:"вул. Якова Бреуса", delay:"NA"},
{ lat:46.446965, lng:30.706615, title:"вул. Маршала Малиновського", delay:"NA"},
{ lat:46.442581, lng:30.705607, title:"пл. Бориса Дерев'янка", delay:"NA"},
{ lat:46.438966, lng:30.702324, title:"вул. Валентини Терешкової", delay:"NA"},
{ lat:46.435772, lng:30.699234, title:"вул. Генерала Петрова", delay:"NA"},
{ lat:46.433435, lng:30.696992, title:"вул. Іцкаха Рабіна", delay:"NA"},
{ lat:46.433687, lng:30.697356, title:"вул. Іцкаха Рабіна", delay:"NA"},
]];
        var directions = new google.maps.DirectionsService();
        var bounds;
        var map;

        function map_stops(stop, len, icol, ecol, col) {
...
//            }
        ...
        window.onload = function() {
            ...
            map_stops(stops[0], stops[0].length, "#00b3fd", "#1f7cb6", "#00b3fd");
            map_stops(stops[1], stops[1].length, "#ff9e00", "#ac7413", "#ff9e00");
...
#                ts = self.ichk(data.get('timestamp'))
                ts = self.ichk(data.get('created_at'))
            ...
            if mac is None: # broadcast?
                if mesg_t == MQTT_TYPE_GPS_INFO:
                    lat=self.fchk(data.get('latitude'))
                    lon=self.fchk(data.get('longitude'))
                    share.put(QTYPE_GPS_INFO, dict(lat=lat, lon=lon))
                    if GPS_TRACKING:
